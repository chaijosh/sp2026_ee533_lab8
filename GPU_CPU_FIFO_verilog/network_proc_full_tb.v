...
/*	  // ADDFP Operation
	  ...
	  debug_pc = 9'd08; debug_instr_in = 32'h14221800; @(negedge clk); // MULTFP $3, $1, $2
	  // Pipeline Data Hazard NOPs (Wait 5 cycles for MULT to reach Writeback stage)
	  debug_pc = 9'd09; debug_instr_in = 32'h00000000; @(negedge clk);
	  debug_pc = 9'd10; debug_instr_in = 32'h00000000; @(negedge clk);
	  debug_pc = 9'd11; debug_instr_in = 32'h00000000; @(negedge clk);
	  ...
	  debug_pc = 9'd14; debug_instr_in = 32'hAC030003; @(negedge clk); // SW $3, 3($0) -> Store ADDFP
	  debug_pc = 9'd15; debug_instr_in = 32'h00000000; @(negedge clk);
	  debug_pc = 9'd16; debug_instr_in = 32'h00000000; @(negedge clk);
	  
	  debug_pc = 9'd17; debug_instr_in = 32'h00000000; @(negedge clk); // Infinite NOP buffer
  ...
  always @(posedge clk) begin
    if (fifo_reset && out_wr && out_rdy) begin
